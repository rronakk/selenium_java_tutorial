...
import com.toolsqa.framework.utility.FrameworkAssert;
...
public class LoginTestUsingFramework extends AbstractTestCaseBase{
	...
	public void run() {
		...
		boolean result = loginPage.login(GlobalConstants.VALID_USERNAME,
				GlobalConstants.VALID_PASSWORD);
		
		FrameworkAssert.assertEquals(result, true);
